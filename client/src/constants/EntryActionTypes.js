...
export default {
  ...
  PROJECT_INTEGRATION_CREATE: `${PREFIX}/PROJECT_INTEGRATION_CREATE`,
  PROJECT_INTEGRATIONS_FETCH: `${PREFIX}/PROJECT_INTEGRATIONS_FETCH`,
  PROJECT_INTEGRATION_UPDATE: `${PREFIX}/PROJECT_INTEGRATION_UPDATE`,
  PROJECT_INTEGRATION_DELETE: `${PREFIX}/PROJECT_INTEGRATION_DELETE`,
  PROJECT_INTEGRATION_CREATE_HANDLE: `${PREFIX}/PROJECT_INTEGRATION_CREATE_HANDLE`,
  PROJECT_INTEGRATION_UPDATE_HANDLE: `${PREFIX}/PROJECT_INTEGRATION_UPDATE_HANDLE`,
  PROJECT_INTEGRATION_DELETE_HANDLE: `${PREFIX}/PROJECT_INTEGRATION_DELETE_HANDLE`,
  PROJECT_INTEGRATION_CREATE_ERROR_CLEAR: `${PREFIX}/PROJECT_INTEGRATION_CREATE_ERROR_CLEAR`,
  ...
  /* Marketing */
  MARKETING_FETCH_COMPLETED_REQUESTS: `${PREFIX}/MARKETING_FETCH_COMPLETED_REQUESTS`,
  MARKETING_FETCH_EVOLUTION_GROUPS: `${PREFIX}/MARKETING_FETCH_EVOLUTION_GROUPS`,
  MARKETING_SEND_WHATSAPP_MESSAGE: `${PREFIX}/MARKETING_SEND_WHATSAPP_MESSAGE`,

  /* Design */
  DESIGN_FETCH_NEW_REQUESTS: `${PREFIX}/DESIGN_FETCH_NEW_REQUESTS`,

  /* Inventory */
  INVENTORY_FETCH: `${PREFIX}/INVENTORY_FETCH`,
  INVENTORY_ERROR_CLEAR: `${PREFIX}/INVENTORY_ERROR_CLEAR`,

  /* Postiz Integrations */
  POSTIZ_INTEGRATIONS_FETCH: `${PREFIX}/POSTIZ_INTEGRATIONS_FETCH`,
  POSTIZ_INTEGRATIONS_ERROR_CLEAR: `${PREFIX}/POSTIZ_INTEGRATIONS_ERROR_CLEAR`,

  /* Postiz Posts */
  POSTIZ_POSTS_FETCH: `${PREFIX}/POSTIZ_POSTS_FETCH`,
  POSTIZ_POSTS_ERROR_CLEAR: `${PREFIX}/POSTIZ_POSTS_ERROR_CLEAR`,
};
