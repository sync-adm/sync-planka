...
export default {
  ...
  translation: {
    common: {
      ...
      enterDomain: 'Enter custom domain...',
      ...
      selectPostizIntegration: 'Select Postiz Integration',
      loadingIntegrations: 'Loading integrations...',
      searchIntegration: 'Type to search for an integration...',
      noIntegrationsFound: 'No integrations found',
      integrationSelected: 'Selected Integration:',
      saveIntegration: 'Save Integration',
      automaticPublishingSettings: 'Automatic Publishing Settings',
      enableFeedPosts: 'Enable Feed Posts',
      enableReelsPosts: 'Enable Reels Posts',
      enableStoryPosts: 'Enable Story Posts',
      defaultPostDescription: 'Default Post Description (Optional)',
      defaultPostDescriptionPlaceholder:
        'e.g., Amazing [marca] [modelo] [versão] [ano] in [cor] - only [km] km!',
      defaultPostDescriptionHelper:
        'If provided, this description will be used instead of the card name for all posts. Click the info icon to see available variables. Hashtags will still be added automatically.',
      availableVariables: 'Available Variables',
      variablesHelp: 'Click on a variable to insert it into the description',
      variables: {
        marca: 'Brand (e.g., Honda, Toyota)',
        modelo: 'Model (e.g., Civic, Corolla)',
        versao: 'Version (e.g., LX 2.0, GLX)',
        cor: 'Color (e.g., Blue, Red)',
        combustivel: 'Fuel type (e.g., Gasoline, Flex)',
        transmissao: 'Transmission (e.g., Manual, Automatic)',
        portas: 'Number of doors (e.g., 4, 2)',
        km: 'Kilometers (e.g., 45000)',
        quilometragem: 'Mileage (same as km)',
        preco: 'Price (e.g., 45000)',
        categoria: 'Category (e.g., SUV, Sedan)',
        ano: 'Model year (e.g., 2022)',
        anoModelo: 'Model year (same as ano)',
        anoFabricacao: 'Manufacturing year',
        blindado: 'Armored (Yes/No)',
        chaveReserva: 'Has spare key (Yes/No)',
        manual: 'Has manual (Yes/No)',
      },
      defaultDescription: 'Default Description',
      enabled: 'Enabled',
      none: 'None',
      activeIntegrations: 'Active Integrations',
      noActiveIntegrations: 'No active integrations at the moment.',
      noActiveIntegrationsDescription: 'Add integrations to manage your social media accounts.',
      errorLoadingIntegrations: 'Error loading Postiz integrations',
      errorLoadingActiveIntegrations: 'Error loading active integrations',
      loadingActiveIntegrations: 'Loading active integrations...',
