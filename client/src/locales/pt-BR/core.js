...
export default {
  ...
  translation: {
    common: {
      ...
      enterStockCode: 'Digite o código do estoque...',
      ...
      selectPostizIntegration: 'Selecionar Integração do Postiz',
      loadingIntegrations: 'Carregando integrações...',
      searchIntegration: 'Digite para buscar uma integração...',
      ...
      defaultPostDescription: 'Descrição Padrão das Postagens (Opcional)',
      defaultPostDescriptionPlaceholder:
        'ex: Incrível [marca] [modelo] [versão] [ano] na cor [cor] - apenas [km] km!',
      defaultPostDescriptionHelper:
        'Se fornecida, esta descrição será usada ao invés do nome do card para todas as postagens. Clique no ícone de informação para ver as variáveis disponíveis. As hashtags ainda serão adicionadas automaticamente.',
      availableVariables: 'Variáveis Disponíveis',
      variablesHelp: 'Clique em uma variável para inseri-la na descrição',
      variables: {
        marca: 'Marca (ex: Honda, Toyota)',
        modelo: 'Modelo (ex: Civic, Corolla)',
        versao: 'Versão (ex: LX 2.0, GLX)',
        cor: 'Cor (ex: Azul, Vermelho)',
        combustivel: 'Combustível (ex: Gasolina, Flex)',
        transmissao: 'Transmissão (ex: Manual, Automático)',
        portas: 'Número de portas (ex: 4, 2)',
        km: 'Quilometragem (ex: 45000)',
        quilometragem: 'Quilometragem (mesmo que km)',
        preco: 'Preço (ex: 45000)',
        categoria: 'Categoria (ex: SUV, Sedan)',
        ano: 'Ano do modelo (ex: 2022)',
        anoModelo: 'Ano do modelo (mesmo que ano)',
        anoFabricacao: 'Ano de fabricação',
        blindado: 'Blindado (Sim/Não)',
        chaveReserva: 'Tem chave reserva (Sim/Não)',
        manual: 'Tem manual (Sim/Não)',
      },
